...
public class C04Reader {
	public static void main(String[] args) throws Exception {
		...
		// read(char[]) : char 배열에 읽은 문자를 채우고 읽은 문자 개수를 리턴
		...
		System.out.println(len1); // 100
		System.out.println(len2); // 100
		System.out.println(len3); // 100
		System.out.println(len4); // 100
		String str4 = new String(buffer);
		System.out.println(len5); // 38
		String str5 = new String(buffer);
		System.out.println(len6); // -1
